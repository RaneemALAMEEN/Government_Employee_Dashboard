      ...
      (paginatedResult) {
        ...
        if (apiStatus == 'pending_pickup') {
          finalAwaiting = paginatedResult.totalCount > 0 
              ...
              : (stats.awaitingSignature > oldAwaiting ? stats.awaitingSignature : oldAwaiting);
        } else {
        ...
        emit(MyTransactionsLoaded(
          ...
          completedMonthCount: stats.completed > oldCompleted ? stats.completed : oldCompleted,
        ));
      },
    );
  }
    ...
    result.fold(
      ...
      (paginatedResult) {
        ...
        emit(loadedState.copyWith(
          ...
          hasMore: paginatedResult.hasNext,
          isLoadingMore: false,
          awaitingSignatureCount: loadedState.apiStatusFilter == 'pending_pickup' && paginatedResult.totalCount > 0
              ? paginatedResult.totalCount 
              : (stats.awaitingSignature > loadedState.awaitingSignatureCount ? stats.awaitingSignature : loadedState.awaitingSignatureCount),
          urgentCount: stats.urgent > loadedState.urgentCount ? stats.urgent : loadedState.urgentCount,
          completedMonthCount: stats.completed > loadedState.completedMonthCount ? stats.completed : loadedState.completedMonthCount,
        ));
      },
    );
  }
