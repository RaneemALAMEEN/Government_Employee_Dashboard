...
///
/// قيود معروفة على Windows دون تحزيم MSIX: الدالتان [cancelAll] و
...
class NotificationService {
  ...
  /// (مُولَّد مرّة واحدة عبر `uuidgen`/`[guid]::NewGuid()` — خاص بهذا التطبيق،
  /// مختلف عن أي تطبيق آخر.)
  static const String _windowsGuid = '8875a25d-ff3f-4057-9f59-1dad1125ce51';

  /// الاسم الظاهر للتطبيق في نظام الإشعارات.
  static const String _appName = 'Government Employee';

  /// معرّف التطبيق بصيغة Company.Product (AppUserModelID).
  static const String _appUserModelId = 'AbuKm.GovernmentEmployee';
