...
///
/// مسؤوليتها تنتهي عند إرجاع `bool`: **لا تنقّل، ولا تمسح التخزين**. كلّ مستدعٍ
/// يقرّر ماذا يفعل عند الفشل (الـ interceptor يمسح ويوجّه إلى `/login`؛ الـ socket
/// يتوقّف/ينتظر فقط).
class TokenRefreshService {
  TokenRefreshService({
    ...
    // تجاوز التحقق من شهادة SSL (مطابق لـ DioClient/AuthInterceptor في هذا
    // المشروع) لتفادي تجمّد المصافحة على بعض بيئات Windows.
